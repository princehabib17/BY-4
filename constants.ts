...
export const CASE_STUDY = {
  ...
  beforeText: "Before, he was successful on paper but suffering internally.\nHe worked relentlessly while neglecting his body—brain fog, low energy, bloating, and digestive issues became normal.\nWith no routine outside work, weight gain left him uncomfortable in his own clothes.\nOutwardly fine. Internally drained.",
  afterText: "Twelve weeks later, you see alignment.\nHis energy is steady. His body is leaner and noticeably stronger.\nMental clarity replaced brain fog, and stress no longer controls his decisions.\nHe shows up with focus and composure—and even performs better at work by handling more physical tasks himself.\nDespite a demanding schedule, his discipline is consistent. He moves with greater control and gratitude."
};
